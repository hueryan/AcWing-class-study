...
操作：
    ...
    (22) d：删除选中的文本
    (23) dd: 删除当前行
    (24) y：复制选中的文本 https://www.cnblogs.com/huahuayu/p/12235242.html
    (25) yy: 复制当前行
...
---> vim同时编辑两个
# 打开文件
vim -o source0.cpp source1.cpp 

# 清空source0.cpp
ggdG

# 切换到source1.cpp
Ctrl + w + w (和关掉网页快捷键重复了，鼠标切换)
...
:3<Enter> 7<Space> <Delete>
gg 29 <Space> <Delete>
:16<Enter> 54 <Space> <Delete>
:9<Enter> 79 <Space> <Delete>
--->
